    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_usuario', models.CharField(max_length=86, unique=True)),
                ('correo', models.EmailField(max_length=254)),
                ('fecha_registro', models.DateField(auto_now=True)),
                ('fecha_nacimiento', models.DateField(default=django.utils.timezone.now)),
                ('institucion_educativa', models.CharField(max_length=255, null=True)),
                ('idiomas', multiselectfield.db.fields.MultiSelectField(choices=[('en', 'Inglés'), ('es', 'Español'), ('fr', 'Francés'), ('de', 'Alemán'), ('cn', 'Chino'), ('jp', 'Japonés'), ('it', 'Italiano'), ('pt', 'Portugués')], max_length=8)),
